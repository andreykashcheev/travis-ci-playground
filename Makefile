...
help:
	...
	@echo "  livehtml   to build local preview of docs using sphinx-autobuild"
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/F5OpenSourceDocumentationTraining.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/F5OpenSourceDocumentationTraining.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/F5OpenSourceDocumentationTraining"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/F5OpenSourceDocumentationTraining"
	@echo "# devhelp"
...
docker-test:
	rm -rf ./_build
	./script/docker-docs.sh ./script/test-docs.sh
